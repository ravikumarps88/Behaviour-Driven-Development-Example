...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.weather.handler' => 'getApi_Weather_HandlerService',
            ...
            'besimple.soap.classmap.demoapi' => 'getBesimple_Soap_Classmap_DemoapiService',
            'besimple.soap.client.builder.demoapi' => 'getBesimple_Soap_Client_Builder_DemoapiService',
            'besimple.soap.client.demoapi' => 'getBesimple_Soap_Client_DemoapiService',
    ...
    /**
     * Gets the 'api.weather.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\SoapClientApi A AppBundle\Services\SoapClientApi instance.
     */
    protected function getApi_Weather_HandlerService()
    {
        return $this->services['api.weather.handler'] = new \AppBundle\Services\SoapClientApi('http://www.webservicex.net/globalweather.asmx?WSDL');
    }
    ...
    /**
     * Gets the 'besimple.soap.classmap.demoapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BeSimple\SoapCommon\Classmap A BeSimple\SoapCommon\Classmap instance.
     */
    protected function getBesimple_Soap_Classmap_DemoapiService()
    {
        return $this->services['besimple.soap.classmap.demoapi'] = new \BeSimple\SoapCommon\Classmap();
    }

    /**
     * Gets the 'besimple.soap.client.builder.demoapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BeSimple\SoapBundle\Soap\SoapClientBuilder A BeSimple\SoapBundle\Soap\SoapClientBuilder instance.
     */
    protected function getBesimple_Soap_Client_Builder_DemoapiService()
    {
        return $this->services['besimple.soap.client.builder.demoapi'] = new \BeSimple\SoapBundle\Soap\SoapClientBuilder('http://www.webservicex.net/globalweather.asmx?WSDL', array('debug' => true), $this->get('besimple.soap.classmap.demoapi'), $this->get('besimple.soap.converter.collection'), $this->get('besimple.soap.cache'));
    }

    /**
     * Gets the 'besimple.soap.client.demoapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BeSimple\SoapBundle\Soap\SoapClientBuilder A BeSimple\SoapBundle\Soap\SoapClientBuilder instance.
     */
    protected function getBesimple_Soap_Client_DemoapiService()
    {
        return $this->services['besimple.soap.client.demoapi'] = $this->get('besimple.soap.client.builder.demoapi')->build();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ae81e19ddd00887507535e5232287a1b9edc925559a79b93092b2eca8cc62f6b');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('61b8223588ccc47973340616437d1710b2768f5c');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55e535336b5c37.64500402')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '61b8223588ccc47973340616437d1710b2768f5c',
            ...
            'kernel.secret' => '61b8223588ccc47973340616437d1710b2768f5c',
            ...
            'besimple.soap.client.builder.class' => 'BeSimple\\SoapBundle\\Soap\\SoapClientBuilder',
            'besimple.soap.classmap.class' => 'BeSimple\\SoapCommon\\Classmap',
